<template>
  <div>
    ...
    <el-table :data="tableData"  :header-cell-style="{background:'#f3f6fd'}" border>
        ...
        <el-table-column prop="name" label="name" width="190">
        </el-table-column>
        <el-table-column prop="rarity" label="rarity" width="280">
        </el-table-column>
        <el-table-column prop="property_change" label="property_change" width="400">
        </el-table-column>
        <el-table-column prop="talent_event_id" label="talent_event_id" width="200">
        </el-table-column>
    ...
    <el-dialog
      title="新增"
         ...
         <el-form ref="form" :rules="rules" :model="form" label-width="150px">
          ...
          <el-form-item label="talent_event_id" prop="talent_event_id">
            <el-input v-model="form.talent_event_id"></el-input>
          </el-form-item>
...
export default{
    ...
    methods:{
      ...
      del(id){
        console.log(id);
        this.$axios.get(this.$httpUrl+'/FourDelete?id='+id
      ...
      save(){
        this.$refs.form.validate((valid)=>{
         ...
         loadPost(){
          //接口，之后要修改
           this.$axios.get(this.$httpUrl+'/Four',{
