<template>
  <div>
    ...
    <el-table :data="tableData"  :header-cell-style="{background:'#f3f6fd'}" border>
        ...
        <el-table-column prop="vacation_id" label="vacation_id" width="200">
        </el-table-column>
    ...
    <el-dialog
      title="新增"
         ...
         <el-form ref="form" :rules="rules" :model="form" label-width="150px">
          ...
          <el-form-item label="vacation_id" prop="vacation_id">
            <el-input v-model="form.vacation_id"></el-input>
          </el-form-item>
...
export default{
    ...
    methods:{
      ...
      del(id){
        console.log(id);
        this.$axios.get(this.$httpUrl+'/FiveDelete?id='+id
      ...
      save(){
        this.$refs.form.validate((valid)=>{
         ...
         loadPost(){
          //接口，之后要修改
           this.$axios.get(this.$httpUrl+'/Five',{
